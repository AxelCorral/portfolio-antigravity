...
export const translations = {
  en: {
    ...
    projects: {
      ...
      intro:
        "Selected projects with methods, live demos or repositories, and evidence points surfaced before the skill list.",
      project: "Project",
      whyItMatters: "Why it matters",
      openCaseStudy: "Open case study",
      viewRepository: "View repository",
      viewDemo: "Open live demo",
      demoLaunch: "Launch the live demo",
  ...
  fr: {
    ...
    projects: {
      ...
      intro:
        "Des projets sélectionnés avec méthodes, démos en ligne ou dépôts, et points de preuve visibles avant la liste de compétences.",
      project: "Projet",
      whyItMatters: "Pourquoi c’est important",
      openCaseStudy: "Voir l’étude de cas",
      viewRepository: "Voir le dépôt",
      viewDemo: "Ouvrir la démo en ligne",
      demoLaunch: "Lancer la démo en direct",
